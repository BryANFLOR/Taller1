...
while True:
    ...
    if opc ==1:
        ...
        if opc2 == '1':
            os.system("cls")
            notas = OpcSistema("0954760401","Central de riesgo","90","Bryan Flor","Personal natural","FOTOGRAFIA B.J","0954760401001")
        ...
        if opc4 == '1':
            os.system("cls")
            notas2= OpcSistema("0954760401","Bryan Flor","90","Javier","STAFF","FOTOGRAFIA B.J","0954760401001")
